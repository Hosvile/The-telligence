...
--[[
local PhantomForcesWindow = Library:NewWindow("Phantom Forces")

local MainCheatsSection = PhantomForcesWindow:NewSection("Main Cheats")

MainCheatsSection:CreateToggle("No Recoil", function(enabled)
	if enabled then 
		print(enabled)
